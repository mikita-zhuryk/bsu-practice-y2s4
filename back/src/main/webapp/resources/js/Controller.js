...
class Controller {
    ...
    updateLikeCounter(likeButton) {
        ...
        if (!controller.logged) {
            ...
            likeButton.firstElementChild.setAttribute("src", "resources/img/like-button-filled.png");
            likeCounter.value = (Number(likeCounter.value) + 1).toString();
            post.likes.push(controller.currentUser);
        }
        else {
            likeButton.firstElementChild.setAttribute("src", "resources/img/like-button.png");
            likeCounter.value = (Number(likeCounter.value) - 1).toString();
