...
class Post {
    ...
    render() {
        ...
        avatar.setAttribute("src", "resources/data/users/" + this._author + "/avatar.png");
        ...
        if (this.likes.includes(controller.currentUser)) {
            newNode.querySelector("#like-button-img").setAttribute("src", "resources/img/like-button-filled.png");
        }
