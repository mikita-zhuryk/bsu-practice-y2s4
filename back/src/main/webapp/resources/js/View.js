...
class View {
    ...
    showMenuIfLogged() {
        if (controller.logged) {
            ...
            menuAvatar.setAttribute("src", "resources/data/users/" + controller.currentUser + "/avatar.png");
            body.insertBefore(menu, main);
            this._addMenuGrayAreaEventListener();
    ...
    showLoggedUI() {
        ...
        avatar.firstElementChild.setAttribute("src", "resources/data/users/" + controller.currentUser + "/avatar.png");
